...
![A diagram that shows how you can onboard managed professional services to {{site.data.keyword.cloud_notm}}.](images/managed-professional-service-workflow.svg){: caption="Onboard managed professional services to {{site.data.keyword.cloud_notm}}."}
...
1. The Business Partner reviews and approves the professional service engagement request
1. The service engagement becomes active
1. The Business Partner manually bills the client for the service
1. The client submits a request to complete the engagement (optional)
1. The Business Partner approves or marks the engagement as completed
...
The Business Partner starts the onboarding process. Creates and onboards managed professional services in the {{site.data.keyword.cloud_notm}} console.
...
- To manage published engagements as a Business Partner, see [Administering managed professional services as an IBM Business Partner](/docs/sell?topic=sell-consume-mps-partner).
