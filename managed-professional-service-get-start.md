...
![A diagram that shows how you can onboard managed professional services to {{site.data.keyword.cloud_notm}}.](images/managed-prof-service-workflow.svg){: caption="Onboard managed professional services to {{site.data.keyword.cloud_notm}}."}
