...
{: caption="Metering model" caption-side="top"}
...
{: caption="Monthly usage calculations" caption-side="top"}
...
{: caption="Average monthly usage calculations" caption-side="top"}
...
{: caption="Maximum monthly usage calculations" caption-side="top"}
...
{: caption="Average usage per day and monthly average calculations" caption-side="top"}
...
{: caption="Maximum usage per day and monthly average calculations" caption-side="top"}
...
{: caption="Monthly prorated cost calculations" caption-side="top"}
...
{: caption="Pricing models" caption-side="top"}
...
{: caption="Partner Center metering model metrics" caption-side="top"}
