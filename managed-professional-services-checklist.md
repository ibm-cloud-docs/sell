...
# Checklist for selling managed professional services on {{site.data.keyword.cloud_notm}}
{: #checklist-mps}

Use the following checklist to track all the tasks that are required to successfully onboard and sell managed professional services on {{site.data.keyword.cloud}}.
{: shortdesc}
...
| ![Checkbox icon](../icons/checkbox-icon.svg "Checkbox") Create a test environment | The test environment is used to onboard your managed professional services and validate it's ready for use. | {{site.data.keyword.cloud_notm}} console |
| ![Checkbox icon](../icons/checkbox-icon.svg "Checkbox") Assign team access | With the correct {{site.data.keyword.cloud_notm}} Identity and Access Management (IAM) access, members of your team can help onboard your managed professional services. | {{site.data.keyword.cloud_notm}} console |
...
{: caption="Getting started tasks for selling managed professional services" caption-side="top"}

For more information, see [Getting set up to sell managed professional services](/docs/sell?topic=sell-mps-getting-started&interface=ui).

## Tell us about your product
{: #mps-checklist-product-details}
...
{: caption="Tasks for adding pricing plans for managed professional services" caption-side="top"}

Usage-based pricing plans are available only for managed professional services that are onboarded with the virtual server image delivery method.
{: note}
...
| Task | Description | Environment |
|------|-------------|-------------|
| ![Checkbox icon](../icons/checkbox-icon.svg "Checkbox") Verify that all tasks are completed | Confirm that you completed the getting started tasks, defined your managed professional services details, and onboarded your managed professional services. | {{site.data.keyword.cloud_notm}} console |
| ![Checkbox icon](../icons/checkbox-icon.svg "Checkbox") Request to publish your managed professional services| Submit a request for {{site.data.keyword.cloud_notm}} to review your product details and approve it's ready for publishing. | {{site.data.keyword.cloud_notm}} console |
| ![Checkbox icon](../icons/checkbox-icon.svg "Checkbox") Publish your managed professional services | After your publishing request is approved, publish your managed professional services to the {{site.data.keyword.cloud_notm}} catalog. | {{site.data.keyword.cloud_notm}} console |
{: caption="Tasks for publishing managed professional services" caption-side="top"}
