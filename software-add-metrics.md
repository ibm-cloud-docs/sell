...
To submit usage for your active software instances, call the [Usage Metering API](/apidocs/usage-metering#report-resource-usage){: external} as shown in the following sample request. To make the API call, your pricing approval request must be approved by {{site.data.keyword.cloud_notm}}.
