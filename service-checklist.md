...
As a third-party provider, you're responsible for maintaining all assets of published services in the {{site.data.keyword.cloud}} catalog and deprecating outdated versions.  
{: note}
